import { r as b, M as I, u as ge, v as j, b as u, j as l, C as K, w as p, x as m, y as se, z as Y, A as _, O as xe, B as E, D as r, F as X, G as ht, H as ut, I as gt, J as f, K as Q, L as Se, N as Ee, E as g, Q as Je, k as ae, l as We, P as Ge, R as ft, V as vt, S as c, T as Ye, U as S, W as mt, X as Pe, Y as Ie, Z as Xe, _ as bt, $ as le, a0 as wt, a1 as Re, a2 as yt, a3 as xt, a4 as Pt, a5 as It, a6 as Ke, a7 as N, a8 as R, a9 as At, aa as $t, ab as Ct, ac as Ze, ad as kt, ae as St, af as Et, ag as Rt, ah as Qe, ai as Dt, aj as Ae, ak as $e, al as Lt, am as Mt } from "./copilot-Dl-fdSrm.js";
import { n as y, r as x } from "./state-BIV67EKX.js";
import { e as O } from "./query-BykXNUlT.js";
import { i as d } from "./icons-CdJ8gudh.js";
import { c as et } from "./index-CK1w8xAu.js";
...
const de = "data-drag-initial-index", J = "data-drag-final-index";
let M = class extends I {
  ...
  cleanUpDragging() {
    this.draggingSectionPanel && (l.setSectionPanelDragging(!1), this.draggingSectionPanel.style.zIndex = "", Array.from(this.querySelectorAll("copilot-section-panel-wrapper")).forEach((e) => {
      e.style.removeProperty("transform"), e.removeAttribute(J), e.removeAttribute(de);
      ...
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          ...
          <div class="hint">
            ...
            <ul>
              ${e.intellij && qt("1.3.0", l.idePluginState?.version) ? r` <li>Upgrade to the latest IntelliJ plugin</li>` : g}
...
var ci = Object.defineProperty, pi = Object.getOwnPropertyDescriptor, q = (e, t, i, n) => {
...
let D = class extends X {
  ...
  renderItemDescription(e) {
    return Object.keys(qe).indexOf(e.name.toLowerCase()) !== -1 ? qe[e.name.toLowerCase()] : null;
  }
  bodyLengthExceeds() {
