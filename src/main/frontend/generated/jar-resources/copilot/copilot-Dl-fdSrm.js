...
const Nt = async (e, t, r) => window.Vaadin.copilot.comm(e, t, r), he = "copilot-", ll = "25.0.3", cl = "undefined", Td = "attention-required", Vd = "https://plugins.jetbrains.com/plugin/23758-vaadin", Id = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", zd = "https://marketplace.eclipse.org/content/vaadin-tools";
function Ud(e) {
...
class Ul {
  constructor() {
    this.supportsHilla = !0, this.springSecurityEnabled = !1, this.springJpaDataEnabled = !1, this.springApplication = !1, this.urlPrefix = "", this.serverVersions = [], this.clientVersions = [{ name: "Browser", version: navigator.userAgent }], $e(this);
  }
  setSupportsHilla(t) {
...
function dc() {
  ke.push(import("./copilot-log-plugin-DueLPXlB.js")), ke.push(import("./copilot-info-plugin-BIcrtxrA.js")), ke.push(import("./copilot-features-plugin-CnY52Sgb.js")), ke.push(import("./copilot-feedback-plugin-BtYbgt7g.js")), ke.push(import("./copilot-shortcuts-plugin-DzdY9yoy.js"));
}
function uc() {
  {
...
let vi = class extends cc {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-DFcVkOF9.js"), await import("./copilot-init-step2-B2BnvrWJ.js"), bl(), dc(), this.tabIndex = 0, Mt.hostConnectedCallback(), window.addEventListener("keydown", Wr), this.addEventListener("keydown", fi), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
